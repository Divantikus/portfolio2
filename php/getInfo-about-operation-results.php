...
class GetInfoAboutOperationResults  {
  ...
  function __construct()
  {
    ...
    } elseif ($this->type == "updGrade"){

      $this->text = $this->res > 0 ? "Оценка успешно обновлена" : "Не удалось обновить оценку";
      $this->linkText = "Обновить оценку";
      $this->linkAddress = "choice-student.php";
